    ...
    <main>
      <div className="lg:w-1/2 lg:m-auto">
        ...
        <div className="mx-10 my-10">
          <p className="text-md">
            Hi, I&apos;m Byron, a software engineer based in Richmond, VA. I
            build full-stack web applications and enjoy using technology to
            solve real world problems. I graduated with a degree in Computer
            Science and was actively involved in Forge, a UVA-based organization
            that empowers students to collaborate on real-world projects and
            startups. Through Forge, I had the opportunity to teach and work
            closely with peers, honing my skills in teamwork, communication, and
            problem-solving.
          </p>
          <br></br>
          <p className="text-md">
