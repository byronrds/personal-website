        ...
        <main>
            <div className='lg:w-1/2 lg:m-auto'>
                ...
                <div className='mx-10 my-10'>
                    <p className='text-md'>
                        Hi, I&apos;m Byron, a software engineer based in Richmond, VA. I focus on
                        building full-stack web applications, using React on the frontend and AWS
                        services on the backend. I graduated with a degree in Computer Science and
                        was actively involved in Forge, a UVA-based organization that empowers
                        students to collaborate on real-world projects and startups. Through Forge,
                        I had the opportunity to teach and work closely with peers, honing my skills
                        in teamwork, communication, and problem-solving.
                    </p>
                    <br></br>
                    <p className='text-md'>
                        In my free time, I enjoy reading, running, traveling, and working on new
                        business ideas. I&apos;m passionate about entrepreneurship, exploring the
                        impact of technology on humanity, and learning about AI and its intersection
                        with human life. I also enjoy meeting new people, learning from their
                ...
                <div className='mx-10 my-10'>
                    ...
                    <div className='mb-8'>
                        <p className='font-semibold text-md'>Software Engineering Instructor</p>
                    ...
                    <div className='mb-8'>
                        <p className='font-semibold text-md'>Computer Systems Teaching Assistant</p>
