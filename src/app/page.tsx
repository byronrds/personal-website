			...
			<div className='lg:w-1/2 lg:m-auto'>
				...
				<div className='mx-10 my-10'>
					<div className='mb-8'>
						...
						<p className='text-md mb-2 italic'>IT Concepts | Sep 2023 - Present</p>
					</div>
					<div className='mb-8'>
						<p className='font-semibold text-md'>Software Engineering Instructor</p>
						<p className='text-md mb-2 italic'>Forge | Aug 2022 - June 2024</p>
					</div>
					<div className='mb-8'>
						<p className='font-semibold text-md'>Software Engineer</p>
					...
					<div className='mb-8'>
						...
						<p className='text-md mb-2 italic'>IT Concepts | June 2023 - Aug 2023</p>
					</div>
					<div className='mb-8'>
						<p className='font-semibold text-md'>Computer Systems TA</p>
						<p className='text-md mb-2 italic'>University of Virginia | Jan 2023 - May 2023</p>
					</div>
				</div>
			</div>
		</main>
