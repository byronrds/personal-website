    ...
    <main>
      <div className="lg:w-1/2 lg:m-auto">
        ...
        <div className="mx-10 my-10">
          <p className="text-md">
            Hi, I'm Byron, a software engineer based in New York City. I focus
            on building full-stack web applications, using React on the frontend
            and AWS services on the backend. I graduated with a degree in
            Computer Science and was actively involved in Forge, a UVA-based
          ...
          <p className="text-md">
            ...
            new business ideas. I’m passionate about entrepreneurship, exploring
            the impact of technology on humanity, and learning about AI and its
            intersection with human life. I also enjoy meeting new people,
            learning from their experiences, and helping them grow.
          </p>
        </div>
        <div className="mx-10 my-10">
